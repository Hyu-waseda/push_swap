...
void	show(t_list *nil_a, t_list *nil_b);///残しちゃダメ
...
void	move_to_nil_b_half(t_list *nil_a, t_list *nil_b, t_cmd_list *nil_c, int pivot);
void	move_to_nil_b_half2(t_list *nil_a, t_list *nil_b, t_cmd_list *nil_c, int pivot);
...
char	*ft_itoa(int n);//消す
size_t	ft_strlen(const char *str);//消す
